...
?>
<input type="text" value="<?php echo $a ?> mmol/L" class="tb3">
</form>
<form method="post" action="">
...
if(isset($_POST['b2']))
{
  ...
  if($row==0)
  {
     $sql = "INSERT INTO tests (testname,username,value,unit,type,report,filename) VALUES ('$test','$session','$result','$unit','C','N','UB2.php')";
  }  
  else
  {
